...
async function generateWizardStep6Spaces() {
  ...
  const prompt = [
    ...
    'REGLA FUNDAMENTAL DE CONGRUENCIA: El ambiente, la locación, la vestimenta y los accesorios DEBEN SER 100% CONGRUENTES Y ADECUADOS AL TEMA del guión ("' + topic + '" / "' + hook + '").',
    'Si el tema es de Finanzas, Negocios, Trading, Ventas o Crecimiento Personal, propón espacios acordes: Despacho moderno, sala de análisis con pantalla/gráficos, terraza ejecutiva, cafetería urbana moderna, set oscuro minimalista con iluminación de acento o tomas dinámicas en movimiento tipo vlog.',
    'PROHIBIDO sugerir cocina o espacios domésticos irrelevantes a menos que el tema del reel trate explícitamente sobre nutrición, comida o recetas.',
    '',
    'Cada opción debe incluir:',
    '1. title: Nombre del concepto/set (ej: "Oficina Ejecutiva & Pantalla de Datos", "Café Urbano con Luz Natural", "Set Dinámico en Movimiento (Vlog Urbano)", "Sala de Estrategia Minimalista", "Estudio Oscuro con Luz de Acento")',
    '2. environment: Descripción del espacio, fondo y ambiente acorde al mensaje (20-30 palabras).',
    '3. outfit: Vestimenta y estilo exacto recomendado (ropa, colores, accesorios acordes al rol).',
    '4. camera: Ángulo, encuadre y movimiento de cámara sugerido (ej: plano medio 9:16, tracking shot).',
    '5. lightingAndAudio: Iluminación y tipo de micrófono/audio recomendado.',
    '6. propsAndEnergy: Props en mano (laptop, smartphone con gráficos, libreta) y energía de voz.',
    '',
    'Responde ÚNICAMENTE con un arreglo JSON válido de 5 objetos:',
    '[',
    '  {',
